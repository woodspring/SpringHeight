...
MAIN_CLASS=com.tts.mde.MarketRateEngineMain
...
ADD_ARGUMENT="-DAPP_NAME=MDE -DUSE_NEW_TPS=true -DuseTPS=TRUE -Dinjection.debug=TRUE "
...
VM_ARGUMENT=" -Xms512M -Xmx1024M  -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled  "
VM_ARGUMENT="$VM_ARGUMENT -XX:+PrintGCDateStamps -verbose:gc -XX:+PrintGCDetails -Xloggc:gc.log  -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=10 -XX:GCLogFileSize=100M "
PROGRAM_ARGUMENT=""

...
public class IndexController {
    ...
    @RequestMapping("/changeMarketMode")
    @ResponseBody
    public String changeMarketMode(@RequestParam("marketMode") String marketMode) {
    	String result;
    	if (marketMode.equals("NORMAL")) {
    		GlobalAppConfig.switchSpreadConfig(marketMode);
    		result = "OK, MARKET MODE SET TO " + marketMode;
    	} else if (marketMode.equals("VOLATILE")) {
    		GlobalAppConfig.switchSpreadConfig(marketMode);
    		result = "OK, MARKET MODE SET TO " + marketMode;
    	} else if (marketMode.equals("SLOW")) {
    		GlobalAppConfig.switchSpreadConfig(marketMode);
    		result = "OK, MARKET MODE SET TO " + marketMode;
    	} else if (marketMode.equals("NO_CHANGE")) {
    		GlobalAppConfig.switchSpreadConfig(marketMode);
    		result = "OK, MARKET MODE SET TO " + marketMode;
    	} else {
    		result = "NOT VALID MARKET MODE";
    	}

...
MAIN_CLASS=com.tts.mas.TtsMarketAdapterServerMain
...
echo "=-=-=-$MYNAME=-=->nohup $JAVA_HOME/bin/java -cp $CLASSPATH $ADD_ARGUMENT $ADDITIONAL_JAVA_OPTS $VM_ARGUMENT $MAIN_CLASS $PROGRAM_ARGUMENT > $LOGS_FOLDER/current/logs.nohup.out 2>&1"
